...
const styles = StyleSheet.create({
  ...
  gameCard: {
    width: 155,
    alignItems: "center",
    borderColor: "#8a2be2", // #8a2be2 no lugar de 'lime' para a borda
    borderWidth: 1.5,
    borderRadius: 10,
    shadowColor: "#8a2be2", // #8a2be2 no lugar de 'lime' para a sombra
  ...
  gameHeader: {
    ...
    fontSize: 22,
    fontWeight: "bold",
    color: "#8a2be2", // Azul escuro para melhor contraste
    marginBottom: 6,
